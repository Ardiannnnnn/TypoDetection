      ...
      <div id="hero" className="pt-20">
        <main className="container mx-auto px-6 py-16">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              <h1 className="text-5xl md:text-6xl font-bold text-gray-800 dark:text-white mb-6 font-poppins">
                {renderTitleWithLineBreak(t("hero.title"))}
              </h1>
              <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed font-poppins">
                {t("hero.subtitle")}
              </p>
            </div>
