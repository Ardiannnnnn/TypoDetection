        ...
        <div className="flex items-center justify-between">
          ...
          >
            <div className="w-7 h-7 sm:w-8 sm:h-8 bg-indigo-600 rounded-lg flex items-center justify-center transition-all duration-200 group-hover:scale-110 group-hover:rotate-3">
              <span className="text-white font-bold text-base sm:text-lg font-poppins">
                T
              </span>
            </div>
            <span
              className={`text-xl sm:text-2xl font-bold font-poppins transition-colors duration-200 group-hover:text-indigo-600 ${
                isScrolled
                    ...
                    <div className="px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700">
                      ...
                      <div className="space-y-2">
                        ...
                        >
                          ...
                          <span className="flex-1 text-left font-medium font-poppins">
                            English
                          </span>
                          {locale === "en" && (
                            <svg
          ...
          {showBackButton && (
            <div className="flex items-center space-x-2">
                ...
                {isMobileControlsOpen && (
                  <div className="absolute right-0 top-full mt-2 w-52 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 py-2 z-50">
                    <div className="px-3 py-2 border-b border-gray-200 dark:border-gray-600">
                      <p className="text-xs font-medium text-gray-700 dark:text-gray-300 font-poppins">
                        Settings
                      </p>
                    </div>
                    ...
                    <div className="px-3 py-2 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-700">
                      <span className="text-xs text-gray-700 dark:text-gray-300 font-poppins">
                        Theme
                      </span>
                      <ModeToggle />
                    </div>
              ...
              <Link
                href={`/${locale}`}
                className={`hidden lg:flex items-center space-x-2 font-medium transition-colors duration-200 font-poppins group focus:outline-none ${"text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300"}`}
              >
                <svg
